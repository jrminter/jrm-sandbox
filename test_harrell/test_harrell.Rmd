...
subtitle: "Chapter 17 Assignment Problems 20-21"
author: "your name"
date: "`r Sys.Date()`"
output:
  html_document:
...
# Data
The data are from Heusner, A. A. 1991. Size and power in mammals.
_Journal of Experimental Biology_ **160**: 25-54.
...
An equation of the form $R = \alpha M ^ \beta$, if errors are multiplicative
on the original scale, can be fitted using linear regression after logging
both sides of the model.

With R you can log while fitting, without creating new variables.
A predicted value plot has the data superimposed, using the original
